                                        ...
                                        <div class="-m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <label class="ml-2 mr-2 text-center">販売中</label>
                                                    <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="2">
                                                    <label class="ml-2 mr-2 text-center">停止中</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-3 px-3 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新する</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
