                                    ...
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="-m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                ...
                                                <div v-if="errors.name" class="text-red-600">{{ errors.kana }}</div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="tel"
                                                ...
                                                <div v-if="errors.name" class="text-red-600">{{ errors.tel }}</div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="email"
                                                ...
                                                <div v-if="errors.name" class="text-red-600">{{ errors.email }}</div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="postcode"
                                                ...
                                                <div v-if="errors.name" class="text-red-600">{{ errors.postcode }}</div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="address"
                                                ...
                                                <div v-if="errors.name" class="text-red-600">{{ errors.address }}</div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="birthday"
                                                ...
                                                <div v-if="errors.name" class="text-red-600">{{ errors.birthday }}</div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <label for="gender0" class="ml-2 mr-2 text-center">男性</label>
                                                    <input type="radio" id="gender" name="gender" v-model="form.gender" value="1">
                                                    <label for="gender1" class="ml-2 mr-2 text-center">女性</label>
                                                    <input type="radio" id="gender" name="gender" v-model="form.gender" value="2">
                                                    <label for="gender2" class="ml-2 mr-2 text-center">その他</label>
                                                </div>
                                                <div v-if="errors.memo" class="text-red-600">{{ errors.gender }}</div>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <button
                                                class="flex mx-auto text-white bg-indigo-500 border-0 py-3 px-3 focus:outline-none hover:bg-indigo-600 rounded text-lg">顧客登録</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
