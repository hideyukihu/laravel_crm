...
class Subtotal implements Scope
{
    ...
    public function apply(Builder $builder, Model $model)
    {
        ...
        items.price * item_purchase.quantity as subtotal, customers.name as customer_name, items.name as item_name, items.price as item_price, item_purchase.quantity, purchases.status, purchases.created_at, purchases.updated_at
        from purchases
